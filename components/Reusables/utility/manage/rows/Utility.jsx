      ...
      {!item || Object.keys(item).length === 0 ? (
        ...
        <>
          <>
            ...
            <td className="px-6 py-4 max-w-64 break-words">
              {(removeHTMLTags(item?.description)?.length > 80
                ? `${removeHTMLTags(item?.description)?.slice(0, 80)}...`
            ...
            <td className={`px-8 py-4 flex flex-row gap-2 items-center ${

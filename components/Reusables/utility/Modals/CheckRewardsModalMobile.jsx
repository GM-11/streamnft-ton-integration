...
import MobileModal from "@/components/Reusables/utility/Modals/MobileModal";
import Button from "@/components/Reusables/utility/Button";
import { useRouter } from "next/router";
import { useAccount } from "wagmi";
import { ChainContext } from "@/context/ChainContext";
import nftCalls from "@/services/utility/nftCalls";
import NFTSlider from "@/components/Reusables/utility/NFTSlider";
import { useUserWalletContext } from "@/context/UserWalletContext";

const CheckRewardsModalMobile = ({
  title,
  handleRedeemReward,
  handleClaimUtility,
  backendData,
  ...
  return (
    <MobileModal openModal={showClaimModal} setOpenModal={setShowClaimModal}>
      {loadingForModal ? (
        <>
                    ...
                    <>
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-col gap-4">
                          {backendData?.collectionUtility?.winners?.map()}
                        </div>
                      </div>
                    </>
                  )}
...
export default CheckRewardsModalMobile;

    ...
    >
      ...
      <div className="border-b-2 border-solid border-black-7 w-full">
        <div className="py-2 flex items-center justify-between w-full">
          <h5 className="text-grayscale-3">Listed NFT</h5>
          <p>{data?.total_list}</p>
        </div>
        <div className="py-2 flex items-center justify-between w-full">
          <h5 className="text-grayscale-3">Total Rented</h5>
          <p>{data?.active_rent}</p>
        </div>
        <div className="py-2 flex items-center justify-between w-full">
          <h5 className="text-grayscale-3">Floor Price</h5>
          <p>
      ...
      <div className="py-2 flex items-center justify-between w-full">
        <h5 className="text-seagreen flex flex-col underline cursor-pointer">
